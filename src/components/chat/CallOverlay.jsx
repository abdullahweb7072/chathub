...
export default function CallOverlay({
    ...
    const avatar = remoteUser?.avatar || null;
            ...
            <div className="relative flex h-full w-full max-w-6xl flex-col overflow-hidden rounded-2xl bg-[#111b21] shadow-2xl">
                ...
                <div className="flex shrink-0 items-center justify-center gap-3 bg-[#202c33] px-4 pb-6 pt-3 sm:gap-4">
                    <button
                        ...
                        className="flex h-12 w-12 items-center justify-center rounded-full bg-white/10 text-xl text-white transition hover:bg-white/20 active:scale-95"
                        aria-label={
                            isMuted
                                ? "Unmute microphone"
                                : "Mute microphone"
